...
/**
 * ctpl_lexer_expr_free_tree: (skip)
 * @expr: A #CtplTokenExpr to free
 * 
 * Frees a whole #CtplTokenExpr tree.
 * See ctpl_token_expr_free().
 */
void
ctpl_lexer_expr_free_tree (CtplTokenExpr *expr)
{
  ctpl_token_expr_free (expr, TRUE);
}

/**
 * ctpl_lexer_expr_dump_tree: (skip)
 * @expr: A #CtplTokenExpr from which start dump
 * 
 * Dumps a #CtplTokenExpr tree as generated by ctpl_lexer_expr_lex() and
 * firends.
 * See ctpl_token_expr_dump().
 */
void
ctpl_lexer_expr_dump_tree (const CtplTokenExpr *expr)
{
